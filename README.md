...
.jw-buffer {
    background-color: rgba(1 ,255, 86 , 0.2) !important;
}
...
playerInstance.setup({
    playlist: [{
    "title": "Reproductor | Star+",
    "description": "Mirar Star+ tudeportetvhd.com",
    "image": getIMG,
      "sources": [
        {
          "default": false,
    ...
    sharing: {},
    logo: {
        file: "https://lh3.googleusercontent.com/-43ozZW3MsZA/ZeVLqE6MITI/AAAAAAAAA7U/cfGCnnj9UJkdHGPBt7JEcqQioWDBT9BIACNcBGAsYHQ/h156/Picsart_24-03-04_01-18-17-693.png",
        link: "https://tudeportetvhd.com/",
        position: "top-right"
    }
});
</script>
